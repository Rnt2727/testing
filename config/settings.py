...
# ALLOWED_HOSTS = ['localhost', '127.0.0.1', '4551-181-176-44-60.ngrok-free.app']
ALLOWED_HOSTS = ['*']
# CSRF_TRUSTED_ORIGINS = ["https://4551-181-176-44-60.ngrok-free.app"]
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "asistencia/static"),  # Usa os.path.join para compatibilidad
]
